...
<?php
	...
	$sql = "SELECT id, factura, nombre, descripcion, color, precio, proveedor, marca, fecha_ent, fecha_sal, cantidad_ent, cantidad_sal, unidad_med, categorias, imagen FROM productos $where";
...
<center><form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
					...
					<b> Buscar Productos: </b><input type="text" id="campo" name="campo" />
					<input type="submit" id="enviar" name="enviar" value="Buscar" class="btn btn-success" />
</form></center>
<a href="producto_agregar.php"><input  class="btn btn-primary" type="button" value="Agregar producto"></a><br>
</div>
